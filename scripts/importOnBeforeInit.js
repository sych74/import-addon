...
var projects = jelastic.env.control.ExecCmdById('${env.envName}', session, '${nodes.cp.master.id}', toJSON([{"command": "bash /home/jelastic/migrator/migrator.sh getProjectList"}]), false).responses[0].out;
