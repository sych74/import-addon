...
var projects = jelastic.env.control.ExecCmdById('${env.envName}', session, '${nodes.cp.master.id}', toJSON([{ command: 'bash /tmp/migrator/migrator.sh getProjectList' }]), true).responses[0].out;
